...
namespace
{
    ...
    static void AppendTraceText(const char* text)
    {
        ...
        /*
         * Runtime breadcrumbs are emitted from gameplay paths. Keep the trace
         * file open and let Windows buffer these writes; opening, closing and
         * physically flushing the file for every breadcrumb stalls the render
         * thread for an entire frame on some disks.
         */
...
/*static*/ void CPCCrashReporter::Install(void)
{
    ...
    if (s_hTrace != INVALID_HANDLE_VALUE)
    {
        WriteAll(s_hTrace,
                 ...
                 "Crash logger: version 3 (buffered gameplay trace)\r\n");
    };
